            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <ul className="text-sm text-gray-700">
                            <li className="mb-2">Support:somyabajpai2318@gmail.com</li>
                            <li className="mb-2">Helpdesk: somya.12113374@lpu.in</li>
                            <li>Feedback: somyabajpai2318@gmail.com</li>
                        </ul>
                    </div>
                </div>
            </div>
